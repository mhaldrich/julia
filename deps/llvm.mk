...
LLVM_CMAKE += -DLLVM_TABLEGEN=$(STAGING_DIR_NATIVE)/usr/bin/llvm-tblgen
LLVM_CMAKE += -DLLVM_CONFIG_PATH=$(STAGING_DIR_NATIVE)/usr/bin/llvm-config
LLVM_CMAKE += -DLLVM_TOOLS_INSTALL_DIR=$(STAGING_DIR_NATIVE)/usr/bin
LLVM_CMAKE += -DLLVM_UTILS_INSTALL_DIR=$(STAGING_DIR_NATIVE)/usr/bin
...
LLVM_CMAKE += -DLLVM_INCLUDE_UTILS=OF -DLLVM_INSTALL_UTILS=OFF
